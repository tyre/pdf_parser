...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 40 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 42 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/pdf_lexer.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/pdf_lexer.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/pdf_lexer.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { string, TokenLine, list_to_string (TokenChars) } } .

-compile({inline,yyaction_3/0}).
-file("src/pdf_lexer.xrl", 12).
yyaction_3() ->
     skip_token .
